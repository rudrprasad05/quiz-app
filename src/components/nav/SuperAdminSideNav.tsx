...
const SuperAdminSideNav = ({ user }: { user: UserType }) => {
  const items: Items[] = [
    {
      name: "Dashboard",
      icon: LayoutDashboard,
      link: `/superadmin/${user.id}/dashboard`,
    },
    {
      name: "Units",
      icon: Book,
      link: `/superadmin/${user.id}/units`,
    },
    { name: "Invite", icon: Send, link: `/superadmin/${user.id}/invite` },
